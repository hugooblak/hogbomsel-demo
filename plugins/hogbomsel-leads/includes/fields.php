...
function npl_choices() {
	return apply_filters(
		...
		array(
			'service'  => array(
				'replacement' => __( 'Lägga om hela taket', 'hogbomsel-leads' ),
				'storm'       => __( 'Storm or hail damage', 'hogbomsel-leads' ),
				'repair'      => __( 'Läcka eller reparation', 'hogbomsel-leads' ),
				'inspection'  => __( 'Bara en besiktning', 'hogbomsel-leads' ),
				'not-sure'    => __( 'Vet inte än', 'hogbomsel-leads' ),
			),
			'timeline' => array(
				'asap'     => __( 'Så snart som möjligt', 'hogbomsel-leads' ),
				'1-3'      => __( 'Inom 1–3 månader', 'hogbomsel-leads' ),
				'research' => __( 'Jag kollar bara priser', 'hogbomsel-leads' ),
			),
		)
	);
}
...
function npl_consent_text() {
	return apply_filters(
		'npl_consent_text',
		__( 'Genom att skicka förfrågan godkänner du att vi kontaktar dig om ditt tak. Vi sparar uppgifterna bara för det, lämnar dem aldrig vidare, och du kan när som helst be oss radera dem.', 'hogbomsel-leads' )
	);
}
...
function npl_statuses() {
	return array(
		'new'       => __( 'New', 'hogbomsel-leads' ),
		'contacted' => __( 'Kontaktad', 'hogbomsel-leads' ),
		'quoted'    => __( 'Quote sent', 'hogbomsel-leads' ),
		'won'       => __( 'Won', 'hogbomsel-leads' ),
		'lost'      => __( 'Lost', 'hogbomsel-leads' ),
		'spam'      => __( 'Misstänkt spam', 'hogbomsel-leads' ),
	);
}
